...
namespace ClinicApp.Domain.Tests.UnitTest.TemporaryTests
{
    public class SessionTests
    {
        ...
        private ErrorOr<Session> GetSession(TimeRange sessionTime) => Session.Schedule(Guid.NewGuid(), sessionTime, (JsonDocument.Parse("""{"test": "test"}""").RootElement), Guid.NewGuid(), Guid.NewGuid(), Guid.NewGuid(), clock,UserRole.Secretary);
